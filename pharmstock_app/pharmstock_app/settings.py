...
"""
Django settings for pharmstock_app project.
...
DATABASES = {
    "default": {
        ...
        "OPTIONS": {
            ...
            "extra_params": os.getenv("DB_EXTRA", "TrustServerCertificate=yes;MARS_Connection=Yes;"),
        },
    }
}
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'stock' / 'static']
